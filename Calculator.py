...
#Building the Calculator window
class Calculator:
    def __init__(self):
        self.window = tk.Tk()
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2", bg=OFF_WHITE, fg=Label_Color, font=DEFAULT_FONT_STYLE, borderwidth=0,command=lambda :self.square())
    ...
    def create_squareroot_button(self):
        button = tk.Button(self.buttons_frame, text="\u221ax", bg=OFF_WHITE, fg=Label_Color, font=DEFAULT_FONT_STYLE, borderwidth=0,command=lambda :self.squareroot())
